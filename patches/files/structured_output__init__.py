...
def strip_speculative_padding(token_ids: Sequence[int]) -> list[int]:
    """Drop rejected-draft -1 padding (always trailing)."""
...
class StructuredOutputManager:
    ...
    # LOCAL BACKPORT of vllm-project/vllm#48200 onto 0.28.0 (2026-09-19).
    # 0.28.0 fed unvalidated post-</think> draft tokens to the grammar, which
    # puts llguidance into a permanent error state (content truncated, HTTP 200)
    # and makes xgrammar reject tokens (HTTP 500). The ParserEngineReasoningAdapter
    # fast path of the upstream PR does not exist in 0.28.0 and is omitted.
